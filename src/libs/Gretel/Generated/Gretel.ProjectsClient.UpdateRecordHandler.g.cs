...
namespace Gretel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_UpdateRecordHandlerSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_UpdateRecordHandlerSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_UpdateRecordHandlerSecurityRequirement0,
            };
        partial void PrepareUpdateRecordHandlerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string modelId,
            ref string handlerId,
            global::Gretel.UpdateRecordHandlerRequest request);
        partial void PrepareUpdateRecordHandlerRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string handlerId,
            global::Gretel.UpdateRecordHandlerRequest request);
        partial void ProcessUpdateRecordHandlerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateRecordHandlerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.RecordHandler> UpdateRecordHandlerAsync(
            string projectId,
            string modelId,
            string handlerId,
        ...
        {
            var __response = await UpdateRecordHandlerAsResponseAsync(
                projectId: projectId,
                modelId: modelId,
                handlerId: handlerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.RecordHandler>> UpdateRecordHandlerAsResponseAsync(
            string projectId,
            string modelId,
            string handlerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateRecordHandlerArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateRecordHandlerSecurityRequirements,
                operationName: "UpdateRecordHandlerAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateRecordHandler",
                                methodName: "UpdateRecordHandlerAsync",
                                pathTemplate: "$\"/projects/{projectId}/models/{modelId}/record_handlers/{handlerId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateRecordHandlerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateRecordHandlerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gretel.RecordHandler.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gretel.AutoSDKHttpResponse<global::Gretel.RecordHandler>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gretel.RecordHandler.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.RecordHandler> UpdateRecordHandlerAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Gretel.UpdateRecordHandlerRequest
            {
                Status = status,
            };

            return await UpdateRecordHandlerAsync(
                projectId: projectId,
                modelId: modelId,
                handlerId: handlerId,
                request: __request,
