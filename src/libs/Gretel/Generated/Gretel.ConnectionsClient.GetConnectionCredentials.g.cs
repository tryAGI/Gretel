...
namespace Gretel
{
    public partial class ConnectionsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_GetConnectionCredentialsSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_GetConnectionCredentialsSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_GetConnectionCredentialsSecurityRequirement0,
            };
        partial void PrepareGetConnectionCredentialsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string connectionId);
        partial void PrepareGetConnectionCredentialsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string connectionId);
        partial void ProcessGetConnectionCredentialsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetConnectionCredentialsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get connection credentials<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.Connection> GetConnectionCredentialsAsync(
            string connectionId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetConnectionCredentialsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.Connection>> GetConnectionCredentialsAsResponseAsync(
            string connectionId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetConnectionCredentialsArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetConnectionCredentialsSecurityRequirements,
                operationName: "GetConnectionCredentialsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Gretel.PathBuilder(
                                path: $"/v1/connections/{connectionId}/credentials",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetConnectionCredentialsAsync",
                                pathTemplate: "$\"/v1/connections/{connectionId}/credentials\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetConnectionCredentialsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetConnectionCredentialsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gretel.Connection.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gretel.AutoSDKHttpResponse<global::Gretel.Connection>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gretel.Connection.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
