...
namespace Gretel
{
    public partial class ConnectionsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_SearchConnectionsSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_SearchConnectionsSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_SearchConnectionsSecurityRequirement0,
            };
        partial void PrepareSearchConnectionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? query,
            ref string? sort,
            ref int? limit,
            ref int? skip);
        partial void PrepareSearchConnectionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            int? skip);
        partial void ProcessSearchConnectionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchConnectionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.ConnectionList> SearchConnectionsAsync(
        ...
        {
            var __response = await SearchConnectionsAsResponseAsync(
                query: query,
                sort: sort,
                limit: limit,
                skip: skip,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.ConnectionList>> SearchConnectionsAsResponseAsync(
            string? query = default,
            string? sort = default,
            int? limit = default,
            int? skip = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSearchConnectionsArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchConnectionsSecurityRequirements,
                operationName: "SearchConnectionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchConnectionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchConnectionsAsync",
                                pathTemplate: "\"/v1/connections/search\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchConnectionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchConnectionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
