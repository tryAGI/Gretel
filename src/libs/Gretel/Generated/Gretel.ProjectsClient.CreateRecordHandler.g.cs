...
namespace Gretel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_CreateRecordHandlerSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_CreateRecordHandlerSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_CreateRecordHandlerSecurityRequirement0,
            };
        partial void PrepareCreateRecordHandlerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string modelId,
            global::Gretel.CreateRecordHandlerRequest request);
        partial void PrepareCreateRecordHandlerRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string modelId,
            global::Gretel.CreateRecordHandlerRequest request);
        partial void ProcessCreateRecordHandlerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateRecordHandlerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.RecordHandler> CreateRecordHandlerAsync(
            string projectId,
            string modelId,
        ...
        {
            var __response = await CreateRecordHandlerAsResponseAsync(
                projectId: projectId,
                modelId: modelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.RecordHandler>> CreateRecordHandlerAsResponseAsync(
            string projectId,
            string modelId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateRecordHandlerArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateRecordHandlerSecurityRequirements,
                operationName: "CreateRecordHandlerAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateRecordHandlerRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateRecordHandler",
                                methodName: "CreateRecordHandlerAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateRecordHandlerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateRecordHandlerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateRecordHandlerAsync(
                projectId: projectId,
                modelId: modelId,
                request: __request,
                requestOptions: requestOptions,
