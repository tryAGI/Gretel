...
namespace Gretel
{
    public partial class WorkflowsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_ValidateWorkflowConfigSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_ValidateWorkflowConfigSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_ValidateWorkflowConfigSecurityRequirement0,
            };
        partial void PrepareValidateWorkflowConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Gretel.ValidateWorkflowConfigRequest request);
        partial void PrepareValidateWorkflowConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Gretel.ValidateWorkflowConfigRequest request);
        partial void ProcessValidateWorkflowConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessValidateWorkflowConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.ValidationResult> ValidateWorkflowConfigAsync(

            global::Gretel.ValidateWorkflowConfigRequest request,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ValidateWorkflowConfigAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.ValidationResult>> ValidateWorkflowConfigAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareValidateWorkflowConfigArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ValidateWorkflowConfigSecurityRequirements,
                operationName: "ValidateWorkflowConfigAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Gretel.PathBuilder(
                                path: "/v1/workflows/validate-config",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareValidateWorkflowConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ValidateWorkflowConfig",
                                methodName: "ValidateWorkflowConfigAsync",
                                pathTemplate: "\"/v1/workflows/validate-config\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessValidateWorkflowConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessValidateWorkflowConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ValidateWorkflowConfigAsync(
                request: __request,
                requestOptions: requestOptions,
