...
namespace Gretel
{
    public partial class WorkflowsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_CancelWorkflowRunSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_CancelWorkflowRunSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_CancelWorkflowRunSecurityRequirement0,
            };
        partial void PrepareCancelWorkflowRunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workflowRunId);
        partial void PrepareCancelWorkflowRunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workflowRunId);
        partial void ProcessCancelWorkflowRunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelWorkflowRunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.WorkflowRun> CancelWorkflowRunAsync(
            string workflowRunId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelWorkflowRunAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowRun>> CancelWorkflowRunAsResponseAsync(
            string workflowRunId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelWorkflowRunArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelWorkflowRunSecurityRequirements,
                operationName: "CancelWorkflowRunAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelWorkflowRunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelWorkflowRunAsync",
                                pathTemplate: "$\"/v1/workflows/runs/{workflowRunId}/cancel\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelWorkflowRunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelWorkflowRunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gretel.WorkflowRun.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowRun>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gretel.WorkflowRun.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
