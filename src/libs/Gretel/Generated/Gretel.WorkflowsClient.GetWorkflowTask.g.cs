...
namespace Gretel
{
    public partial class WorkflowsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_GetWorkflowTaskSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_GetWorkflowTaskSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_GetWorkflowTaskSecurityRequirement0,
            };
        partial void PrepareGetWorkflowTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workflowTaskId);
        partial void PrepareGetWorkflowTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workflowTaskId);
        partial void ProcessGetWorkflowTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWorkflowTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.WorkflowTask> GetWorkflowTaskAsync(
            string workflowTaskId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWorkflowTaskAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowTask>> GetWorkflowTaskAsResponseAsync(
            string workflowTaskId,
            global::Gretel.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWorkflowTaskArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWorkflowTaskSecurityRequirements,
                operationName: "GetWorkflowTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Gretel.PathBuilder(
                                path: $"/v1/workflows/runs/tasks/{workflowTaskId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetWorkflowTaskAsync",
                                pathTemplate: "$\"/v1/workflows/runs/tasks/{workflowTaskId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWorkflowTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWorkflowTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gretel.WorkflowTask.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowTask>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gretel.WorkflowTask.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
