...
namespace Gretel
{
    public partial class WorkflowsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_SearchWorkflowsSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_SearchWorkflowsSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_SearchWorkflowsSecurityRequirement0,
            };
        partial void PrepareSearchWorkflowsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? query,
            ref string? sort,
            ref int? limit,
            ref int? skip);
        partial void PrepareSearchWorkflowsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            int? skip);
        partial void ProcessSearchWorkflowsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchWorkflowsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.WorkflowList> SearchWorkflowsAsync(
        ...
        {
            var __response = await SearchWorkflowsAsResponseAsync(
                query: query,
                sort: sort,
                limit: limit,
                skip: skip,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowList>> SearchWorkflowsAsResponseAsync(
            string? query = default,
            string? sort = default,
            int? limit = default,
            int? skip = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSearchWorkflowsArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchWorkflowsSecurityRequirements,
                operationName: "SearchWorkflowsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchWorkflowsAsync",
                                pathTemplate: "\"/v1/workflows/search\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchWorkflowsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchWorkflowsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Gretel.WorkflowList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Gretel.AutoSDKHttpResponse<global::Gretel.WorkflowList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Gretel.WorkflowList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
