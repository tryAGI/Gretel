...
namespace Gretel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_CreateProjectInviteSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_CreateProjectInviteSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_CreateProjectInviteSecurityRequirement0,
            };
        partial void PrepareCreateProjectInviteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Gretel.CreateInviteRequest request);
        partial void PrepareCreateProjectInviteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Gretel.CreateInviteRequest request);
        partial void ProcessCreateProjectInviteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateProjectInviteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.Invite> CreateProjectInviteAsync(
            string projectId,
        ...
        {
            var __response = await CreateProjectInviteAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.Invite>> CreateProjectInviteAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateProjectInviteArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateProjectInviteSecurityRequirements,
                operationName: "CreateProjectInviteAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateProjectInviteAsync",
                                pathTemplate: "$\"/projects/{projectId}/invites\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateProjectInviteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateProjectInviteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateProjectInviteAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
