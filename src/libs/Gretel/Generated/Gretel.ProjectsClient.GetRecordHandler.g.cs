...
namespace Gretel
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement s_GetRecordHandlerSecurityRequirement0 =
        ...
        private static readonly global::Gretel.EndPointSecurityRequirement[] s_GetRecordHandlerSecurityRequirements =
            new global::Gretel.EndPointSecurityRequirement[]
            {                s_GetRecordHandlerSecurityRequirement0,
            };
        partial void PrepareGetRecordHandlerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string modelId,
            ref string handlerId,
            ref string? expand);
        partial void PrepareGetRecordHandlerRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string handlerId,
            string? expand);
        partial void ProcessGetRecordHandlerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRecordHandlerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Gretel.RecordHandler> GetRecordHandlerAsync(
            string projectId,
            string modelId,
            string handlerId,
        ...
        {
            var __response = await GetRecordHandlerAsResponseAsync(
                projectId: projectId,
                modelId: modelId,
                handlerId: handlerId,
                expand: expand,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gretel.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gretel.AutoSDKHttpResponse<global::Gretel.RecordHandler>> GetRecordHandlerAsResponseAsync(
            string projectId,
            string modelId,
            string handlerId,
            string? expand = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRecordHandlerArguments(
            ...
            var __authorizations = global::Gretel.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRecordHandlerSecurityRequirements,
                operationName: "GetRecordHandlerAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRecordHandlerRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Gretel.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetRecordHandler",
                                methodName: "GetRecordHandlerAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRecordHandlerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Gretel.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRecordHandlerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
